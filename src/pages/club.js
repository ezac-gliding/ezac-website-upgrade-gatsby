        ...
        <ParallaxProvider>
          <div className="hero">
            <div className="wrapper">
              ...
              <p className="hero-title">
                &ldquo;Een unieke&nbsp;
                <strong>vliegclub</strong>
                &nbsp;waar de leden alles&nbsp;
                <strong>zelf ondernemen</strong>
                &rdquo;
              </p>
              <Parallax
          ...
          <div className="block yellow">
            <div className="wrapper">
              ...
              <Parallax
                style={{ top: '300px', right: '-200px', zIndex: 3 }}
                className="floating-bubble"
                speed={-10}
              >
                <ImageBubble fill="#244059" x="-300" y={-50} scale="700px" imgScale="1000px" src="/assets/working-together.jpg" />
              </Parallax>
            </div>
          </div>
